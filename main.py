                ...
                <div class="row text-center">
                    ...
                    <div class="col-12 mt-1">
                        <p class="d-inline-flex gap-1">
                          <a class="btn btn-success" data-bs-toggle="collapse" href="#collapseExample1"
                        ...
                        <div class="collapse" id="collapseExample2">
                            <div class="card card-body">
                                ...
                                Служба доставки работает с 10:00 до 00:00 без выходных.
                                Сотрудник курьерской службы свяжется с вами за час до приезда.
                            </div>
                        </div>
                        <div class="collapse" id="collapseExample3">
                            <div class="card card-body">
                                Мы заботимся о наших клиентах и помогаем каждому покупателю.
                                Это касается, конечно же, и гарантийного обсуживается.
                            </div>
                        </div>
                    </div>
                </div>
